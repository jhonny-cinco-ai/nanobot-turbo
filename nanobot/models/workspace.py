"""Workspace data model for multi-agent orchestration."""
...
class WorkspaceType(Enum):
    """Types of workspaces in the system."""
...
@dataclass
class SharedContext:
    """Shared memory for a workspace (all bots see this)."""
...
class Workspace:
    ...
    type: WorkspaceType  # OPEN, PROJECT, DIRECT, COORDINATION
    ...
    def add_message(self, sender: str, content: str) -> Message:
        """Add a message to workspace history.
    ...
    def is_active(self) -> bool:
        ...
        Returns:
            True if workspace is still active
        """
        if not self.history:
            return False
    ...
    def get_last_message(self) -> Optional[Message]:
        """Get the most recent message in workspace.
